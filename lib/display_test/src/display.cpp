...
void display::u8g2_box_frame(uint8_t a)
{
...
void display::u8g2_r_frame(uint8_t a)
{
...
void display::u8g2_string(uint8_t a)
{
    u8g2->setFontDirection(0);
...
void display::u8g2_line(uint8_t a)
{
...
void display::u8g2_triangle(uint8_t a)
{
    uint16_t offset = a;
...
void display::u8g2_extra_page(uint8_t a)
{
...
void display::u8g2_bitmap_overlay(uint8_t a)
{
...
void display::u8g2_bitmap_modes(uint8_t transparent)
{
